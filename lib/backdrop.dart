...
class _BackdropState extends State<Backdrop>
  ...
  void didUpdateWidget(Backdrop old) {
    ...
    if (widget.currentCategory != old.currentCategory) {
      setState(() {
        _controller.fling(
            velocity:
            _topPanelVisible ? -_kFlingVelocity : _kFlingVelocity);
      });
    } else if (!_topPanelVisible) {
      setState(() {
  ...
  void _toggleBackdropPanelVisibility() {
    ...
    _controller.fling(
        velocity: _topPanelVisible ? -_kFlingVelocity : _kFlingVelocity);
  }
